...
# APPEND Compiler FLAGS per language (we override because CMake forcely defines them)
foreach( _lang C CXX Fortran )
  if( ECBUILD_${_lang}_FLAGS )
    set( CMAKE_${_lang}_FLAGS "${CMAKE_${_lang}_FLAGS} ${ECBUILD_${_lang}_FLAGS}" )
  endif()
endforeach()
