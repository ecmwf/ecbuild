...
foreach( _comp IN LISTS _search_components )
  ...
  if( _val )
    ...
    if(${NetCDF_${_comp}_LIBRARY} AND NOT NetCDF_${_comp}_LIBRARY_SHARED)
      message(WARNING "Unable to properly find NetCDF.  Found static libraries at: ${NetCDF_${_comp}_LIBRARY} but could not run nc-config: ${NetCDF_${_comp}_CONFIG_EXECUTABLE}")
    endif()
  endif()
