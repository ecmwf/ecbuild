...
macro( ecbuild_find_omp )
  ...
  if( CMAKE_CXX_COMPILER_LOADED AND _OMP_CXX_FLAG )
    ...
    check_cxx_source_compiles("${OMP_CXX_TEST_SOURCE}" CXX_COMPILER_SUPPORTS_OMP )
    set(CMAKE_REQUIRED_FLAGS "${SAVE_CMAKE_REQUIRED_FLAGS}")
    if( CXX_COMPILER_SUPPORTS_OMP )
      ...
      check_c_source_compiles("${OMPSTUBS_CXX_TEST_SOURCE}" CXX_COMPILER_SUPPORTS_OMPSTUBS )
      set(CMAKE_REQUIRED_FLAGS "${SAVE_CMAKE_REQUIRED_FLAGS}")
    endif()
  endif()
