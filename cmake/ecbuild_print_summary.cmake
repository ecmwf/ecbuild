...
if( NOT ${CMAKE_EXE_LINKER_FLAGS} MATCHES "^$" AND NOT ${CMAKE_EXEC_LINKER_FLAGS_${EC_BUILD_TYPE}} MATCHES "^$" )
    message( STATUS " shared exe flags : [${CMAKE_EXE_LINKER_FLAGS} ${CMAKE_EXEC_LINKER_FLAGS_${EC_BUILD_TYPE}}]" )
endif()
if( NOT ${CMAKE_SHARED_LINKER_FLAGS} MATCHES "^$" AND NOT ${CMAKE_SHARED_LINKER_FLAGS_${EC_BUILD_TYPE}} MATCHES "^$" )
